    ...
    media: [
      {
        ...
        title:
          "Complete Automatic Bottling Line | Vial Filling, Capping, Sealing & Labeling",
      ...
      },
      {
        ...
        description:
          "Rotary accumulation table collecting finished vials at the end of an Automatic Vial Bottling Line.",
      },
      {
        type: "video",
        url: "https://youtu.be/EHHh7Ui7ZOE",
        title: "Labeling Machine - Automatic Vial Bottling Line",
        description:
          "Rotary accumulation table collecting finished vials at the end of an Automatic Vial Bottling Line.",
      },
    ],
...
export function getProductionLinesByIndustry(
  industry: string
): ProductionLine[] {
  return productionLines.filter(
    (line) => line.industry.toLowerCase() === industry.toLowerCase()
  );
}
