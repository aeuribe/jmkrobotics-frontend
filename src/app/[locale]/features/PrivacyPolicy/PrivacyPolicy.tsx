      ...
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mb-8 sm:mb-12">
          <div className="space-y-4 text-[#A8B2C1] leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>Visit our website at <a href="http://www.jmkrobotics.com" className="text-[#ff002f] hover:text-white transition-colors">http://www.jmkrobotics.com</a> or any website of ours that links to this Privacy Notice</li>
              <li>Engage with us in other related ways, including any sales, marketing, or events</li>
            </ul>
            <div className="bg-[#ff002f]/10 border border-[#ff002f]/20 p-4 sm:p-6 mt-6">
              <h3 className="text-[#ff002f] font-semibold mb-2">Questions or concerns?</h3>
              <p className="text-[#A8B2C1] text-sm sm:text-base">
                Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@servicesjmk.com" className="text-[#ff002f] hover:text-white transition-colors">info@servicesjmk.com</a>.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-4 text-[#A8B2C1] leading-relaxed">
            ...
            <div className="grid gap-4 mt-6">
              <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
                <h3 className="text-[#ff002f] font-semibold mb-2">What personal information do we process?</h3>
              ...
              <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
                <h3 className="text-[#ff002f] font-semibold mb-2">Do we process any sensitive personal information?</h3>
                <p className="text-sm sm:text-base">
              ...
              <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
                <h3 className="text-[#ff002f] font-semibold mb-2">Do we collect any information from third parties?</h3>
                <p className="text-sm sm:text-base">
              ...
              <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
                <h3 className="text-[#ff002f] font-semibold mb-2">How do we process your information?</h3>
                <p className="text-sm sm:text-base">
              ...
              <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
                <h3 className="text-[#ff002f] font-semibold mb-2">How do we keep your information safe?</h3>
                <p className="text-sm sm:text-base">
              ...
              <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
                <h3 className="text-[#ff002f] font-semibold mb-2">How do you exercise your rights?</h3>
                <p className="text-sm sm:text-base">
                  The easiest way to exercise your rights is by visiting <a href="http://www.jmkrobotics.com/contact" className="text-[#ff002f] hover:text-white transition-colors">http://www.jmkrobotics.com/contact</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold text-white mb-4 sm:mb-6 
            ...
            <Database size={24} className="text-[#ff002f]" />
            1. What Information Do We Collect?
          </h2>
          <div className="space-y-6 text-[#A8B2C1] leading-relaxed">
            
            <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
              <h3 className="text-[#ff002f] font-semibold mb-3 flex items-center gap-2">
                <Users size={16} />
              ...
              <div className="bg-[#ff002f]/10 border border-[#ff002f]/20 p-4 mt-4">
            ...
            <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
              ...
              <p className="mb-4">
                Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: <a href="http://www.jmkrobotics.com/cookie-policy" className="text-[#ff002f] hover:text-white transition-colors">www.jmkrobotics/cookie-policy</a>.
              </p>
              
              <div className="bg-[#ff002f]/10 border border-[#ff002f]/20 p-4 mt-4">
                <h4 className="text-white font-semibold mb-2">The information we collect includes:</h4>
                <div>
                  <h5 className="text-[#ff002f] font-semibold mb-2">Location Data.</h5>
                  <p className="text-sm sm:text-base">
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold text-white mb-4 sm:mb-6 
                        border-b border-[#2E3C51] pb-3 flex items-center gap-3">
            <Shield size={24} className="text-[#ff002f]" />
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="space-y-4 text-[#A8B2C1] leading-relaxed">
            ...
            <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
              <h3 className="text-[#ff002f] font-semibold mb-2">Business Transfers.</h3>
              <p>
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="space-y-4 text-[#A8B2C1] leading-relaxed">
            ...
            <p>
              Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="http://www.jmkrobotics.com/cookie-policy" className="text-[#ff002f] hover:text-white transition-colors">www.jmkrobotics/cookie-policy</a>.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold text-white mb-4 sm:mb-6 
                        border-b border-[#2E3C51] pb-3 flex items-center gap-3">
            <Clock size={24} className="text-[#ff002f]" />
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold text-white mb-4 sm:mb-6 
                        border-b border-[#2E3C51] pb-3 flex items-center gap-3">
            <Lock size={24} className="text-[#ff002f]" />
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="space-y-4 text-[#A8B2C1] leading-relaxed">
            ...
            <p>
              If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at <a href="mailto:info@servicesjmk.com" className="text-[#ff002f] hover:text-white transition-colors">info@servicesjmk.com</a>.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="space-y-4 text-[#A8B2C1] leading-relaxed">
            ...
            <div className="space-y-4">
              <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
                <h3 className="text-[#ff002f] font-semibold mb-2">Withdrawing your consent:</h3>
                <p>
              ...
              <div className="bg-[#0A1220]/30 border border-[#2E3C51] p-4 sm:p-6">
                <h3 className="text-[#ff002f] font-semibold mb-2">Cookies and similar technologies:</h3>
                <p>
                  Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: <a href="http://www.jmkrobotics.com/cookie-policy" className="text-[#ff002f] hover:text-white transition-colors">www.jmkrobotics/cookie-policy</a>.
                </p>
              </div>
            </div>

            <p>
              If you have questions or comments about your privacy rights, you may email us at <a href="mailto:info@servicesjmk.com" className="text-[#ff002f] hover:text-white transition-colors">info@servicesjmk.com</a>.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold text-white mb-4 sm:mb-6 
                        border-b border-[#2E3C51] pb-3 flex items-center gap-3">
            <FileText size={24} className="text-[#ff002f]" />
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="space-y-4 text-[#A8B2C1] leading-relaxed">
            <p>
              If you have questions or comments about this notice, you may email us at <a href="mailto:info@servicesjmk.com" className="text-[#ff002f] hover:text-white transition-colors">info@servicesjmk.com</a> or contact us by post at:
            </p>
        ...
        <section className="mb-0">
          ...
          <div className="space-y-4 text-[#A8B2C1] leading-relaxed">
            ...
            <p>
              These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please visit: <a href="http://www.jmkrobotics.com/contact" className="text-[#ff002f] hover:text-white transition-colors">http://www.jmkrobotics.com/contact</a>.
            </p>
          </div>
        </section>
